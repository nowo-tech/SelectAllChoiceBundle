...
2. Create an annotated tag: `git tag -a v1.4.0 -m "Release 1.4.0"`.
3. Push the tag: `git push origin v1.4.0` (or your default branch name, e.g. `main`).
...
git commit -m "Release v1.4.0: changelog, upgrading, release doc"
