...
- [x] CHANGELOG: [1.1.0] with date and changes; [Unreleased] empty.
- [x] UPGRADING: 1.0.1 → 1.1.0 section.
...
2. Create an annotated tag: `git tag -a v1.1.0 -m "Release 1.1.0"`.
3. Push the tag: `git push origin v1.1.0` (or your default branch name, e.g. `main`).
...
git commit -m "Release v1.1.0: changelog, upgrading, release doc"
