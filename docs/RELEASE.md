...
- [x] CHANGELOG: [1.4.6] with date and changes; [Unreleased] empty.
- [x] UPGRADING: 1.4.5 → 1.4.6 section.
...
2. Create an annotated tag: `git tag -a v1.4.6 -m "Release 1.4.6"`.
3. Push the tag: `git push origin v1.4.6` (or your default branch name, e.g. `main`).
...
git commit -m "Release v1.4.6: changelog, upgrading, release doc, demo locks"
